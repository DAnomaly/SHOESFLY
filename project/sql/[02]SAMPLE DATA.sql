...
-- MEMBER 샘플 수정 21.07.29
-- 작성자 : 안소은

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'apple', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '김민지', 'apple@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'bread', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '최수빈', 'bread@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'ground', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '조승원', 'ground@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'buck', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '주수빈', 'buck@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'ash', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '김우빈', 'ash@home.com', SYSDATE, 0, 0);
...
INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'appleLove', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'SteveJobs', 'apple203@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'samsungZZang', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '이재용', 'samsungZZang@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'strawBar', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '이민호', 'strawBar@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'Mac', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', 'Mac', 'Mac@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'Woo', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '정우성', 'Woo@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'Tae', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '김태희', 'Tae@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'rainism', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '정지훈', 'rainism@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'psy', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '박재상', 'psy@home.com', SYSDATE, 0, 0);

INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, PW, NAME, EMAIL, REGDATE, MANAGER, STATE)
VALUES (MEMBER_SEQ.NEXTVAL, 'JYP', '0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c', '박진영', 'JYP@home.com', SYSDATE, 0, 0);
...
-- MEMBER_ADDRESS 샘플 수정 21.07.29
-- 작성자 : 안소은

-- MEMBER_ADDRESS 샘플

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 2, '집', '서울시 강동구 성내로 25', 'c동 101호', 0);

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 2, '회사', '서울시 중구 을지로6길', '삼호타워 602호', 0);

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 3, '집', '서울시 서대문구 독립문로8길', 'b동 612호', 0);

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 3, '회사', '부산광역시 해운대구 세실로 59', '105동 203호', 0);

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 4, '집', '전라남도 여수시 망마로 3', '403동 709호', 0);

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 4, '회사', '서울시 강남구 강남대로 310', '비즈니스타워 1804호', 0);

INSERT INTO MEMBER_ADDRESS (MEMBER_ADDRESS_NO, MEMBER_NO, NAME, ADDR1, ADDR2, STATE)
VALUES (MEMBER_ADDRESS_SEQ.NEXTVAL, 5, '집', '서울시 강북구 수유로12길', 'd동 101호', 0);
...
VALUES (REVIEW_SEQ.NEXTVAL,
        ...
        'Jordan 1 Retro High OG Black Mocha',
        'SHOEFLY고마워요',
        '이 신발은 어디에든 매치해도 이쁜거같아요~너무 맘에드네요~',
        'review2.jpg',
        SYSDATE,
        SYSDATE,
        5,
...
VALUES (REVIEW_SEQ.NEXTVAL,
        ...
        'Nike Dunk Low SP Veneer',
        '득템했어요!!!',
        '넘예뻐서 집에서만 신어보고 아직 예쁘게 보관중입니다ㅎㅎ',
        'review4.jpg',
        SYSDATE,
        SYSDATE,
        4,
...
VALUES (REVIEW_SEQ.NEXTVAL,
        ...
        'Adidas Yeezy Boost 700 V2 Cream',
        '무난하니 이뻐요~',
        '예전부터 사고싶었던 신발인데 단종되서 구하기 힘들었는데shoefly덕분에 구했습니다~',
        'review8.jpg',
        SYSDATE,
        SYSDATE,
        1,
